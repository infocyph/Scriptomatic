...
Detailed contracts and dependencies are documented in [`docs/script-contracts.md`](docs/script-contracts.md). Security assumptions are documented in [`docs/security-review.md`](docs/security-review.md).
